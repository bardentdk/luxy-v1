    ...
    public function show(Quote $quote)
    {
        ...
        return Inertia::render('Commercial/Quotes/Show', [
            'quote' => [
                ...
                // ── Dates format ISO pour les inputs ──
                'issued_at'        => $quote->issued_at->format('Y-m-d'),
                'expires_at'       => $quote->expires_at->format('Y-m-d'),
                // ── Dates format humain pour l'affichage ──
                'issued_at_label'  => $quote->issued_at->translatedFormat('d F Y'),
                'expires_at_label' => $quote->expires_at->translatedFormat('d F Y'),
                ...
                'notes'            => $quote->notes,
                'terms'            => $quote->terms,
                'sent_at'          => $quote->sent_at?->translatedFormat('d F Y H:i'),
                'accepted_at'      => $quote->accepted_at?->translatedFormat('d F Y H:i'),
